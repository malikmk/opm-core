...
namespace Opm
{
    ...
    {
        OPM_THROW(std::runtime_error, "Pestc just can be used by paramers.");
    }

    LinearSolverPetsc::LinearSolverPetsc(int argc, char** argv)
        : argc_(argc)
        , argv_(argv)
        , ksp_type_("gmres")
        , pc_type_("sor")
        ...
        , maxits_(1e5)
    {
        PetscInitialize(&argc_, &argv_, (char*)0, "Petsc interface for OPM!\n");
    }
